...
Terraform module at `modules/cloudwatch/alarms/rds/free_storage` with single responsibility.
...
| `db_instance_identifier` | Input variable. |
...
```hcl
module "free_storage_example" {
  source = "<relative-path-to>/modules/cloudwatch/alarms/rds/free_storage"
  # set required inputs
}
```
