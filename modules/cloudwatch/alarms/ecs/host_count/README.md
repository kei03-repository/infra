...
Terraform module at `modules/cloudwatch/alarms/ecs/host_count` with single responsibility.
...
```hcl
module "host_count_example" {
  source = "<relative-path-to>/modules/cloudwatch/alarms/ecs/host_count"
  # set required inputs
}
```
